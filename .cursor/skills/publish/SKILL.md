...
**Optional vor dem Merge (Best Practice):** Auf `develop` einmal `npm run build` (und ggf. `npm run typecheck`) ausführen. Bei Fehlern abbrechen – so wird nichts Kaputtes nach main gemergt.
